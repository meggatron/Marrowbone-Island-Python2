...
def boathouse():
    ...
    gui.display("""
You enter the old boathouse.
A giant shrimp sits beside a washing machine.
""")
    ...
    if "slingshot" in player.inventory:
        ...
        if trade == "yes":
            ...
            gui.display("The shrimp takes the token and gives you the slingshot.")
        else:
            gui.display("The shrimp shrugs and keeps polishing the slingshot.")

    else:
        gui.display("The shrimp says: \nBring me a token, and I'll trade you something useful.")
