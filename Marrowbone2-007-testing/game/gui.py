...
def draw_text(lines, input_text=None):
    ...
    inventory_text = "Inventory: " + (", ".join(sorted(player.inventory)) if player.inventory else "empty")
    inventory_surface = font.render(inventory_text, True, pygame.Color("yellow"))
    screen.blit(inventory_surface, (40, 20))
    ...
    for i, line in enumerate(lines):
        ...
        screen.blit(line_surface, (40, 90 + i * 35))
